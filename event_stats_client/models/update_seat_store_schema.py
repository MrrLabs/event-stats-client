...
from event_stats_client.models.price_seat_store_schema import PriceSeatStoreSchema
from typing import Optional, Set
from typing_extensions import Self

class UpdateSeatStoreSchema(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSeatStoreSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSeatStoreSchema from a dict"""
        if obj is None:
            return None
