...
from event_stats_client.models.single_change_schema import SingleChangeSchema
...
class VividseatsChangeSchema(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VividseatsChangeSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VividseatsChangeSchema from a dict"""
        if obj is None:
            return None
