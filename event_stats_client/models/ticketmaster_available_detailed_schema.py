...
class TicketmasterAvailableDetailedSchema(BaseModel):
    ...
    inserted: datetime
    __properties: ClassVar[List[str]] = ["place_id", "full_section", "section", "row", "row_rank", "seat_number", "attributes", "offer_id", "offer_name", "sellable_quantities", "protected", "description", "inventory_type", "list_price", "total_price", "inserted"]
