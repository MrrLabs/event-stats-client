...
from event_stats_client.models.seat_store_schema import SeatStoreSchema
from event_stats_client.models.update_seat_store_schema import UpdateSeatStoreSchema
...
class SeatStoreRequestSchema(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SeatStoreRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SeatStoreRequestSchema from a dict"""
        if obj is None:
            return None
