...
from event_stats_client.models.available_info import AvailableInfo
from event_stats_client.models.pagination_schema import PaginationSchema
from event_stats_client.models.vividseats_available_schema import VividseatsAvailableSchema
from typing import Optional, Set
from typing_extensions import Self

class VividseatsAvailableResponseSchema(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VividseatsAvailableResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VividseatsAvailableResponseSchema from a dict"""
        if obj is None:
            return None
